...
static const uint8_t hid_string_manufacturer[] = "OpenChord X RMIT Exertion Games Lab";
static const uint8_t hid_string_product[]      = "UnoJoy Joystick";
